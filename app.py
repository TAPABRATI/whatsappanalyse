...
if uploaded_file is not None:
     ...
     selected_user = st.sidebar.selectbox("Show analysis with respcet to",user_list)
     ...
     if st.sidebar.button("Show Analysis "):
          ...
          # user activity heatmap in hour
          st.title("Activity map by hour")
